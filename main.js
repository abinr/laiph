...
var _user$project$PhoenixChannel$decodeEventId = A2(
...
var _user$project$PhoenixChannel$decodeEvent = function (rawEvent) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _user$project$PhoenixChannel$decodeEventId, rawEvent);
};
var _user$project$PhoenixChannel$encodeEvent = function (_p0) {
	var _p1 = _p0;
	return A2(
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$object(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'body', _1: _p1.body},
										_1: {ctor: '[]'}
									})
							},
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'ref',
									_1: _elm_lang$core$Json_Encode$string('0')
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$PhoenixChannel$Channel = function (a) {
	return {server: a};
};
var _user$project$PhoenixChannel$init = function (server) {
	return _user$project$PhoenixChannel$Channel(
		A2(_elm_lang$core$Basics_ops['++'], server, '/socket/websocket'));
};
var _user$project$PhoenixChannel$ChannelMessage = F3(
	function (a, b, c) {
		return {topic: a, event: b, body: c};
	});
var _user$project$PhoenixChannel$join = F3(
	function (topic, body, channel) {
		var joinEvent = A3(
			_user$project$PhoenixChannel$ChannelMessage,
			topic,
			'phx_join',
		...
		return A2(
			...
			channel.server,
			_user$project$PhoenixChannel$encodeEvent(joinEvent));
	});
var _user$project$PhoenixChannel$send = F3(
	function (event, chatMsg, channel) {
		var newMsg = A3(
			_user$project$PhoenixChannel$ChannelMessage,
			'gozp:lobby',
			event,
			_elm_lang$core$Json_Encode$string(chatMsg));
		return A2(
			_elm_lang$websocket$WebSocket$send,
			channel.server,
			_user$project$PhoenixChannel$encodeEvent(newMsg));
	});
var _user$project$PhoenixChannel$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$PhoenixChannel$Event = function (a) {
	return {ctor: 'Event', _0: a};
};
var _user$project$PhoenixChannel$event = function (rawEvent) {
	var _p2 = _user$project$PhoenixChannel$decodeEvent(
		A2(_elm_lang$core$Debug$log, '', rawEvent));
	if (_p2.ctor === 'Ok') {
		return _user$project$PhoenixChannel$Event(
			{ctor: '_Tuple2', _0: _p2._0, _1: rawEvent});
	} else {
		return _user$project$PhoenixChannel$Error(_p2._0);
	}
};
var _user$project$PhoenixChannel$subscriptions = function (channel) {
	return A2(_elm_lang$websocket$WebSocket$listen, channel.server, _user$project$PhoenixChannel$event);
};

var _user$project$Main$cellView = function (isAlive) {
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'live', _1: isAlive},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'dead', _1: !isAlive},
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Main$cellRow = function (row) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Main$cellView, row));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		A2(_elm_lang$core$List$map, _user$project$Main$cellRow, model.cells));
};
var _user$project$Main$decodeCells = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'payload',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Board':
				var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodeCells, _p0._0);
				if (_p1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {channel: a, width: b, height: c, cells: d, error: e};
	});
var _user$project$Main$init = function () {
	var model = A5(
		_user$project$Main$Model,
		_user$project$PhoenixChannel$init('ws://localhost:8015'),
		'',
		'',
		{ctor: '[]'},
		'');
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: A3(_user$project$PhoenixChannel$join, 'life:game', '', model.channel)
	};
}();
...
var _user$project$Main$routeEvent = function (chMsg) {
	var _p2 = chMsg;
	if (_p2.ctor === 'Event') {
		var _p3 = _p2._0._0;
		if (_p3 === 'board') {
			return _user$project$Main$Board(_p2._0._1);
		} else {
			return _user$project$Main$NoOp;
		}
	} else {
		return _user$project$Main$Error(_p2._0);
	}
};
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Main$routeEvent,
		_user$project$PhoenixChannel$subscriptions(model.channel));
};
